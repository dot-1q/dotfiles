...
require('lazy').setup {
  ...
  { -- Useful plugin to show you pending kybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>f'] = { name = 'Netrw', _ = 'which_key_ignore' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    keys = {
      ...
      },
      {
        ...
        desc = '[S]earch [S]elect telescope.builtin',
      },
      {
        '<leader>sw',
        function()
...

  {
    ...
    init = function()
      ...
      vim.api.nvim_set_hl(0, 'MatchParen', { underline = false, bold = true, fg = palette.orange })
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --[[ REPLACED THIS STATUS LINE WITH ANOTHER ]]
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'html', 'lua', 'vim', 'vimdoc', 'python', 'go', 'yaml', 'json' },
  ...
  -- Enable these ones for better treesitter
...
-- Set keymap to open Netrw, both in file dir, and working dir
-- Also resize the left split to 40
-- And keep netrw workind dir same as browsing dir
vim.keymap.set('n', '<leader>fd', ':Lexplore %:p:h<CR> :vertical resize 40<CR>', options)
vim.keymap.set('n', '<leader>fw', ':Lexplore<CR> :vertical resize 40<CR>', options)
vim.g.netrw_keepdir = 0
-- Add the folding help from treesitte
vim.opt.foldmethod = 'expr'
vim.opt.foldexpr = 'nvim_treesitter#foldexpr()'
vim.opt.foldenable = false -- Disable auto folding on open
-- vim.opt.foldtext = 'nvim_treesitter#foldtext()'
-- Weird bug where the first fold, folds everything
